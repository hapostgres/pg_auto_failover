...
\definecolor{abox}{HTML}{FFB900} % MS amber -- cold storage, distinct from primary/standby
\definecolor{atxt}{HTML}{2F2F2F} % off-black
...
\tikzstyle{archiver}=[mpnode,text=atxt,draw=white,
	rectangle split part fill={abox,abox,white}]
...
\tikzstyle{wal}=[>->,color=abox,text=atxt,line width=0.15em,densely dashed]
