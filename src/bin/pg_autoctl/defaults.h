...
#define PG_AUTOCTL_SSL_SELF_SIGNED "PG_AUTOCTL_SSL_SELF_SIGNED"
#define PG_AUTOCTL_AUTH_METHOD "PG_AUTOCTL_AUTH_METHOD"
#define PG_AUTOCTL_PG_HBA_LAN "PG_AUTOCTL_PG_HBA_LAN"
...
#define CITUS_MASTER_UPDATE_NODE_LOCK_COOLDOWN 10000
#define CITUS_COORDINATOR_WAIT_MAX_RETRIES 100
#define CITUS_COORDINATOR_WAIT_TIMEOUT 300
#define DEFAULT_CITUS_ROLE "primary"
#define DEFAULT_CITUS_CLUSTER_NAME "default"
#define DEFAULT_CITUS_DBNAME "citus"
 ...
 * listens on, loopback only -- see service_archiver_basebackup.c's own
 * replay/volatile implementation */
#define PG_AUTOCTL_ARCHIVER_REPLAY_PORT 6899
