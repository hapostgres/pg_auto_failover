...
void make_conninfo_field_str(PQExpBuffer destination, const char *key, const char *value);
void make_conninfo_field_int(PQExpBuffer destination, const char *key, int value);
