...
KeeperFSMTransition KeeperFSM[] = {
	 ...
	 */
	{ SECONDARY_STATE, MAINTENANCE_STATE, COMMENT_SECONDARY_TO_MAINTENANCE, PGSTATUS_UNKNOWN, &fsm_start_maintenance_on_standby },
	{ CATCHINGUP_STATE, MAINTENANCE_STATE, COMMENT_SECONDARY_TO_MAINTENANCE, PGSTATUS_UNKNOWN, &fsm_start_maintenance_on_standby },
