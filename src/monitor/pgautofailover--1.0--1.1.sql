...
ALTER TABLE pgautofailover.formation ADD COLUMN  number_sync_standbys INT NOT NULL DEFAULT 1;
...
ALTER TABLE pgautofailover.node DROP COLUMN waldelta;
ALTER TABLE pgautofailover.node ADD COLUMN reportedlsn pg_lsn NOT NULL DEFAULT '0/0';
ALTER TABLE pgautofailover.node ADD COLUMN candidatepriority INT NOT NULL DEFAULT 100;
ALTER TABLE pgautofailover.node ADD COLUMN replicationquorum BOOL NOT NULL DEFAULT true;


ALTER TABLE pgautofailover.event DROP COLUMN waldelta;
ALTER TABLE pgautofailover.node ADD COLUMN reportedlsn pg_lsn NOT NULL DEFAULT '0/0';
ALTER TABLE pgautofailover.node ADD COLUMN candidatepriority INT;
ALTER TABLE pgautofailover.node ADD COLUMN replicationquorum BOOL;
