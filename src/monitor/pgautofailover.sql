...
--
-- A pg_auto_failover node that handles a local archive for Postgres nodes
--
...
CREATE TABLE pgautofailover.basebackup
 (
    ...
    checkpoint_location   pg_lsn not null,
...
--
-- A Postgres WAL file, archived on one of the known archiver nodes
--
