 ...
 */
AutoFailoverNode *
GetAutoFailoverNodeWithFormationAndName(char *formationId, char *nodeName)
{
	AutoFailoverNode *pgAutoFailoverNode = NULL;
	MemoryContext callerContext = CurrentMemoryContext;
 ...
 */
int
AddAutoFailoverNode(char *formationId, int groupId,
					...
					bool replicationQuorum)
{
	...
	const char *insertQuery =
		...
		" VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING nodeid";
...
/*
 * ReportAutoFailoverNodeReplicationSetting persists the replication properties
 * of a node.
 *
 * We use SPI to automatically handle triggers, function calls, etc.
 */
void
ReportAutoFailoverNodeReplicationSetting(int nodeid,
										 char *nodeHost,
										 int nodePort,
										 int candidatePriority,
										 bool replicationQuorum)
